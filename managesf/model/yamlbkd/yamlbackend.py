...
from managesf.controllers.utils import timeit
...
class YAMLBackend(object):
    ...
    def _update_cache(self):
        ...
        yaml.dump(self.data, file(self.cache_path, 'w'), Dumper=yaml.CDumper)
    ...
    def _load_from_cache(self):
        if not os.path.isfile(self.cache_path_hash):
            ...
            if cached_repo_hash == repo_hash:
                self.data = timeit(yaml.load)(file(self.cache_path),
                                              Loader=yaml.CLoader)
