...
class ProjectManager(BaseResourceManager):
    ...
    def get(self, **kwargs):
        ...
        member_id: if the user is a member of a group used in an ACL applied to
            a repository within the project, return the project"""
...
class ACLManager(BaseResourceManager):
    ...
    def get(self, **kwargs):
        ...
        member_id: a group member on which the ACL applies
