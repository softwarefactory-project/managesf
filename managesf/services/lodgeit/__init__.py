...
class Lodgeit(base.BaseServicePlugin):
    """Very simple Lodgeit plugin only used for backups."""

    _config_section = "lodgeit"
    service_name = "lodgeit"

    def __init__(self, conf):
        super(Lodgeit, self).__init__(conf)
